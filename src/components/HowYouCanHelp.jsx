...
import two from 'icons/button_check.svg';
import three from 'image/help1.jpg';
import five from 'icons/help1.svg';
import six from 'icons/copy_active.svg';
          ...
          <div className="donat-block">
              ...
              <div className="donat-block__first-button-block">
                ...
                <label htmlFor="first-currency" id="first-currency-label">
                  <div className="currency-button-image">
                    <img src={two} alt="copy_active"></img>
                  </div>
                  <div>UAH</div>
                </label>
                <CurrencyButton
            ...
            <div className="donat-block__third-button-block">
              <button class="donat-button1" onClick={() => { if (isFormValid && (option2 !== "" || textInput !== "")) { submitFunction() } else { validateForm() } }}>
                ...
                <img src={five} alt="button-img"></img>
              </button>
            </div>
            <div className="donat-block__fourth-button-block">
              ...
              >
                <ButtonFunc class="donat-button2">
                  Донат за допомогою картки
                  <img src={one} alt="button-img"></img>
                </ButtonFunc>
              </a>
            </div>
          </div>
          <div className="img-block">
            <img src={three} alt="woman and child" />
          </div>
        </div>
              ...
              <div className="table-block">
                <div className="table-block__name-company">
                  ...
                  <div className="table-block__image">
                    <img src={six} onClick={() => clipboardCopying(1)} alt="copy_active"></img>
                  </div>
                </div>
                <div className="table-block__name-company">
                  ...
                  <div className="table-block__image">
                    <img src={six} onClick={() => clipboardCopying(2)} alt="copy_active"></img>
                  </div>
                </div>
                <div className="table-block__name-company">
                  ...
                  <div className="table-block__image">
                    <img src={six} onClick={() => clipboardCopying(3)} alt="copy_active"></img>
                  </div>
                </div>
                <div className="table-block__name-company">
                  ...
                  <div className="table-block__image">
                    <img src={six} onClick={() => clipboardCopying(4)} alt="copy_active"></img>
                  </div>
                </div>
                <div className="table-block__name-company">
                  ...
                  <div className="table-block__image">
                    <img src={six} onClick={() => clipboardCopying(5)} alt="copy_active"></img>
                  </div>
                </div>
                <div className="table-block__name-company">
                  ...
                  <div className="table-block__image">
                    <img src={six} onClick={() => clipboardCopying(6)} alt="copy_active"></img>
                  </div>
                </div>
                <div className="table-block__name-company">
                  ...
                  <div className="table-block__image">
                    <img src={six} onClick={() => clipboardCopying(7)} alt="copy_active"></img>
                  </div>
                </div>
                <ButtonFunc class="table-block__button" onClick={() => clipboardCopying(30)}>
                  Copy all data<img src={six} alt="copy_active"></img>
                </ButtonFunc>
                {pageState[1] && <div className='table-block__pop-up'><div>Дані скопійовано в буфер обміну</div><div className='pop-up-icon'><img src={two} alt="copy_active"></img></div></div>}
              </div>
            </div>
            <div className="bank-information-block">
              <section>EUR</section>
              <div className="table-block">
                <div className="table-block__name-company">
                  ...
                  <div className="table-block__image">
                    <img src={six} onClick={() => clipboardCopying(8)} alt="copy_active"></img>
                  </div>
                </div>
                <div className="table-block__name-company">
                  <div className="table-block__title">IBAN код</div>
                  ...
                  <div className="table-block__image">
                    <img src={six} onClick={() => clipboardCopying(9)} alt="copy_active"></img>
                  </div>
                </div>
                <div className="table-block__name-company">
                  <div className="table-block__title">Назва банку</div>
                  ...
                  <div className="table-block__image">
                    <img src={six} onClick={() => clipboardCopying(10)} alt="copy_active"></img>
                  </div>
                </div>
                <div className="table-block__name-company">
                  <div className="table-block__title">Адреса банку</div>
                  ...
                  <div className="table-block__image">
                    <img src={six} onClick={() => clipboardCopying(11)} alt="copy_active"></img>
                  </div>
                </div>
                <div className="table-block__name-company">
                  <div className="table-block__title">Код ЄДРПОУ</div>
                  <div className="table-block__name">44773154</div>
                  <div className="table-block__image">
                    <img src={six} onClick={() => clipboardCopying(12)} alt="copy_active"></img>
                  </div>
                </div>
                <div className="table-block__name-company">
                  <div className="table-block__title">SWIFT код</div>
                  <div className="table-block__name">PBANUA2</div>
                  <div className="table-block__image">
                    <img src={six} onClick={() => clipboardCopying(13)} alt="copy_active"></img>
                  </div>
                </div>
                <div className="table-block__name-company">
                  <div className="table-block__title">Адреса компанії</div>
                  ...
                  <div className="table-block__image">
                    <img src={six} onClick={() => clipboardCopying(14)} alt="copy_active"></img>
                  </div>
                </div>
                <div className="table-block__name-company">
                  ...
                  <div className="table-block__image">
                    <img src={six} onClick={() => clipboardCopying(15)} alt="copy_active"></img>
                  </div>
                </div>
                <div className="table-block__name-company">
                  ...
                  <div className="table-block__image">
                    <img src={six} onClick={() => clipboardCopying(16)} alt="copy_active"></img>
                  </div>
                </div>
                <div className="table-block__name-company">
                  ...
                  <div className="table-block__image">
                    <img src={six} onClick={() => clipboardCopying(17)} alt="copy_active"></img>
                  </div>
                </div>
                <div className="table-block__name-company">
                  ...
                  <div className="table-block__image">
                    <img src={six} onClick={() => clipboardCopying(18)} alt="copy_active"></img>
                  </div>
                </div>
                <ButtonFunc class="table-block__button" onClick={() => clipboardCopying(31)}>
                  Copy all data<img src={six} alt="copy_active"></img>
                </ButtonFunc>
                {pageState[2] && <div className='table-block__pop-up'><div>Дані скопійовано в буфер обміну</div><div className='pop-up-icon'><img src={two} alt="copy_active"></img></div></div>}
              </div>
            </div>
            <div className="bank-information-block">
              <section>USD</section>
              <div className="table-block">
                <div className="table-block__name-company">
                  ...
                  <div className="table-block__name">БЛАГОДІЙНА ОРГАНІЗАЦІЯ “БЛАГОДІЙНИЙ ФОНД “А- ХЕЛП УКРАЇНА””</div>
                  <div className="table-block__image">
                    <img src={six} onClick={() => clipboardCopying(19)} alt="copy_active"></img>
                  </div>
                </div>
                <div className="table-block__name-company">
                  <div className="table-block__title">IBAN код</div>
                  ...
                  <div className="table-block__image">
                    <img src={six} onClick={() => clipboardCopying(20)} alt="copy_active"></img>
                  </div>
                </div>
                <div className="table-block__name-company">
                  <div className="table-block__title">Назва банку</div>
                  ...
                  <div className="table-block__image">
                    <img src={six} onClick={() => clipboardCopying(21)} alt="copy_active"></img>
                  </div>
                </div>
                <div className="table-block__name-company">
                  <div className="table-block__title">Адреса банку</div>
                  <div className="table-block__name">Україна, м. Київ, вулиця Грушевського, будинок 1Д</div>
                  <div className="table-block__image">
                    <img src={six} onClick={() => clipboardCopying(22)} alt="copy_active"></img>
                  </div>
                </div>
                <div className="table-block__name-company">
                  <div className="table-block__title">Код ЄДРПОУ</div>
                  <div className="table-block__name">44773154</div>
                  <div className="table-block__image">
                    <img src={six} onClick={() => clipboardCopying(23)} alt="copy_active"></img>
                  </div>
                </div>
                <div className="table-block__name-company">
                  <div className="table-block__title">SWIFT код</div>
                  <div className="table-block__name">PBANUA2</div>
                  <div className="table-block__image">
                    <img src={six} onClick={() => clipboardCopying(24)} alt="copy_active"></img>
                  </div>
                </div>
                <div className="table-block__name-company">
                  <div className="table-block__title">Адреса компанії</div>
                  <div className="table-block__name">Україна, м. Харків, вул. Валентинiвська, будинок 58А квартира 333-33</div>
                  <div className="table-block__image">
                    <img src={six} onClick={() => clipboardCopying(25)} alt="copy_active"></img>
                  </div>
                </div>
                <div className="table-block__name-company">
                  <div className="table-block__title">Банк кореспондент</div>
                  ...
                  <div className="table-block__image">
                    <img src={six} onClick={() => clipboardCopying(26)} alt="copy_active"></img>
                  </div>
                </div>
                <div className="table-block__name-company">
                  <div className="table-block__title">Адреса банку кореспондента</div>
                  ...
                  <div className="table-block__image">
                    <img src={six} onClick={() => clipboardCopying(27)} alt="copy_active"></img>
                  </div>
                </div>
                <div className="table-block__name-company">
                  <div className="table-block__title">Рахунок в банку кореспонденті</div>
                  ...
                  <div className="table-block__image">
                    <img src={six} onClick={() => clipboardCopying(28)} alt="copy_active"></img>
                  </div>
                </div>
                <div className="table-block__name-company">
                  <div className="table-block__title">SWIFT код банку кореспондента</div>
                  ...
                  <div className="table-block__image">
                    <img src={six} onClick={() => clipboardCopying(29)} alt="copy_active"></img>
                  </div>
                </div>
                <ButtonFunc class="table-block__button" onClick={() => clipboardCopying(32)}>
                  Copy all data<img src={six} alt="copy_active"></img>
                </ButtonFunc>
                {pageState[3] && <div className='table-block__pop-up'><div>Дані скопійовано в буфер обміну</div><div className='pop-up-icon'><img src={two} alt="copy_active"></img></div></div>}
              </div>
            </div>
          </div>
        </div>
